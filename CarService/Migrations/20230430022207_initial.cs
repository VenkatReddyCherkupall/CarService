        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FName = table.Column<string>(type: "nvarchar(15)", maxLength: 15, nullable: true),
                    LName = table.Column<string>(type: "nvarchar(15)", maxLength: 15, nullable: true),
                    ...
                    InsuranceNumber = table.Column<string>(type: "nvarchar(12)", maxLength: 12, nullable: true),
                    InsuranceCompany = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DriversLicenceNumber = table.Column<int>(type: "int", maxLength: 9, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    VehicleID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    VinNumber = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
                    Make = table.Column<string>(type: "nvarchar(15)", maxLength: 15, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Services_people_MechanicID",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PartsUsedID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PartName = table.Column<string>(type: "nvarchar(15)", maxLength: 15, nullable: true),
                    PartNumber = table.Column<string>(type: "nvarchar(5)", maxLength: 5, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PartsUsed", x => x.PartsUsedID);
                    table.ForeignKey(
